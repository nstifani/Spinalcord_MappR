...
for (FileI in 1:nlevels(OutputData$File_ID)){
  ...
  NbMarkers=nlevels(OutputDataI$Marker_Name)
    par(xpd=TRUE)
  plot(OutputDataI$X_Pixel_Centered, OutputDataI$Y_Pixel_Centered,
       type="p", bty="n",
       pch=1,lwd=0.5, cex=0.5, col=BlueToRedPalette(NbMarkers,1)[OutputDataI$Marker_Name],
  ...
  legend("bottomleft",
         ...
         title="Marker",
         legend=levels(OutputDataI$Marker_Name),
         xjust = 0.5, yjust = 0.5
  )
...
for (SubjectI in 1:nlevels(OutputData$Subject_ID)){
 ...
 # SC_Layout_File<- file.choose(new = FALSE)
 #  SC_Layout_Data<-read.data(SC_Layout_File)
 #  ellipse(center=c(0,0),shape=matrix(c(4.5,0,0,4.5), nrow=2,ncol=2, byrow=FALSE), radius=0.5,add=TRUE, col="black", center.pch=1, center.cex=0, segments=1000,xlab="",ylab="", lwd=1, lty=1)
 #  add.image(xpos=0, ypos=0, z=0, adj.x=0.5, adj.y=0.5, image.width=2, image/image.height = NULL, col=tim.colors(256))
 #  
...
# # plot(ControlData$X_Pixel_Centered, ControlData$Y_Pixel_Centered,
# #      pch=1, cex=0.5,
# #      bty="n",
# #      #yaxt="n",
# #      #xaxp=c(0,600,3),
...
# # plot(ControlData$X_Scaled, ControlData$Y_Scaled,
# #      pch=1, cex=0.5,
# #      bty="n",
# #      #yaxt="n",
# #      #xaxp=c(0,600,3),
...
# # plot(TestData$X_Pixel_Centered, TestData$Y_Pixel_Centered,
# #      pch=1, cex=0.5,
# #      bty="n",
# #      #yaxt="n",
# #      #xaxp=c(0,600,3),
...
# # plot(TestData$X_Scaled, TestData$Y_Scaled,
# #      pch=1, cex=0.5,
# #      bty="n",
# #      #yaxt="n",
# #      #xaxp=c(0,600,3),
...
# # 
# # 
# # hist(ControlData$X_Scaled[ControlData$X_Scaled>0])
# # abline(v=mean(ControlData$X_Scaled[ControlData$X_Scaled>0]),col="red")
# # abline(v=mean(ControlData$X_Scaled[ControlData$X_Scaled>0])-2*sd(ControlData$X_Scaled[ControlData$X_Scaled>0]),col="grey")
# # abline(v=mean(ControlData$X_Scaled[ControlData$X_Scaled>0])+2*sd(ControlData$X_Scaled[ControlData$X_Scaled>0]),col="grey")
# # 
...
# # 
# # data1<-TestData$X_Scaled[TestData$X_Scaled>0]
# # data2<-TestData$Y_Scaled[TestData$X_Scaled>0]
# # data3<-ControlData$X_Scaled[ControlData$X_Scaled>0]
# # data4<-ControlData$Y_Scaled[ControlData$X_Scaled>0]
# # data<-data1
# # 
# # boxplot(data)
# # var(data)
...
# # 
# # 
# # if( shapiro.test(ControlData$Y_Scaled[ControlData$X_Scaled>0])$p.value>0.05){
# #   print("Data is not normally distruted")
# # }
# # shapiro.test(TestData$X_Scaled[TestData$X_Scaled<0])
# # 
# # hist(ControlData$X_Scaled[ControlData$X_Scaled>=0])
# # 
# # hist(ControlData$Y_Scaled[ControlData$X_Scaled>0])
# # 
# # summary(ControlData$X_Scaled[ControlData$X_Scaled>0])
# # sd(ControlData$X_Scaled[ControlData$X_Scaled>0])
# # summary(ControlData$Y_Scaled[ControlData$X_Scaled>0])
# # sd(ControlData$Y_Scaled[ControlData$X_Scaled>0])
# # summary(TestData$X_Scaled[TestData$X_Scaled>0])
# # sd(TestData$X_Scaled[TestData$X_Scaled>0])
# # summary(TestData$Y_Scaled[TestData$X_Scaled>0])
# # sd(TestData$Y_Scaled[TestData$X_Scaled>0])
# # 
...
# # JustScaledCoordinates$X_Scaled<-OutputData$X_Scaled
# # JustScaledCoordinates$Y_Scaled<-OutputData$Y_Scaled
# # 
# # JustScaledCoordinatesLeft<-JustScaledCoordinates[JustScaledCoordinates$X_Scaled<0,]
# # JustScaledCoordinatesRight<-JustScaledCoordinates[JustScaledCoordinates$X_Scaled>=0,]
# # 
# # JustScaledCoordinatesLeftFlippedtoRight<-JustScaledCoordinatesLeft
# # JustScaledCoordinatesLeftFlippedtoRight$X_Scaled<- - JustScaledCoordinatesLeftFlippedtoRight$X_Scaled
# # 
